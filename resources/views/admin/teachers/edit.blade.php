...
@section('title', "Editar professor [$teacher->name]")
  ...
  <div class="container">
    <div class="row mb-4 d-flex align-items-center">
      <div class="col-auto d-flex align-items-center">
        ...
        <span class='pl-3'>Editar professor</span>
      </div>
    </div>
    <form  name="updateForm" id="updateForm" action="{{ route('teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data" >
      @csrf
      {{ method_field('PUT') }}
        ...
        <div class="form-group row">
            ...
            <div class="col-3">
                ...
                <input type="text"
                        ...
                        value="{{ $teacher->value_per_vip_class }}"
    ...
    @include('admin.teachers._delete', ['large' => true])
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="w-25 text-right">Ação</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @foreach ($teacher->files as $file)
                        <tr>
                            <td scope="row">
                                <a href="{{ route('teachers-files.show', $file)}}">{{$file->filename}}</a>
                            </td>
                            <td class="text-right">
                                @include('admin.teachers.files._delete')
                            </td>
                        </tr>
                    @endforeach
                </tbody>
